      ...
      <div className="container-max flex items-center justify-between py-4 px-6">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <button 
            ...
            className="text-cool-grey hover:text-accent-blue transition-colors"
          >
            Capabilities
          </button>
          <button 
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-deep-navy/95 backdrop-blur-lg md:hidden">
            <div className="flex flex-col py-6 px-6 space-y-4">
              <button 
                onClick={() => scrollToSection('capabilities')}
                className="text-white hover:text-sky-glow transition-colors text-left"
              >
                Capabilities
              </button>
              <button 
